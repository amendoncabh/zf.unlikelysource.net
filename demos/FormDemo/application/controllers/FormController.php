...
class FormController extends Zend_Controller_Action
{
     ...
     * Decorator test form
     */
    public function decoratorTestAction()
    {
    	// Locate the form file in /application/forms/Address.php
    	// Uses decorators to reproduce an HTML table
        $form = new Form_DecoratorTest();
        $this->view->form = $form;
        $this->view->msg = "<h1>Demonstrates Use of the Description Decorator</h1>";
    }
    ...
    {
    	$this->view->form = new Form_NotEmpty();
    }
}
